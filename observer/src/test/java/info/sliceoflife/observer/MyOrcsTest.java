...
public class MyOrcsTest extends MyWeatherObserverTest<MyOrcs> {
   ...
   */
  public MyOrcsTest(final MyWeatherType weather, final String response) {
    super(weather, response, MyOrcs::new);
  }
